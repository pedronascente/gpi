    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <?php if (in_array($pedidoComissao, $permissoes) || in_array($confComissao, $permissoes)) { ?>
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Comissão <span class="caret"></span></a>
                        <ul class="dropdown-menu">
            ...
            <?php if (in_array($gerente, $permissoes) || in_array($auditoria, $permissoes) || $_SESSION['user_info']['id_usuario'] == 491) { ?>
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Ger&ecirc;ncia <span class="caret"></span></a>
                        <ul class="dropdown-menu">
            ...
            <?php } ?>
            <?php if (in_array($rh, $permissoes) || in_array($desenvolvedor, $permissoes) || in_array($supervisor, $permissoes) || in_array($sesmt, $permissoes)) { ?>
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <?php if (in_array($desenvolvedor, $permissoes)) { ?>
                                ...
                                <li><a href="index.php?pg=53">Currículos</a></li>
                            <?php } ?>
                            <?php if (in_array($sesmt, $permissoes)) { ?>
                                 <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Sesmt<span class="caret"></span></a>
                                    <li>
                                        <a href="index.php?pg=74">
                                            Relatório 
                                        </a>
                                    </li>
                                </li>
            ...
            <?php if (in_array($almoxarifado, $permissoes) || in_array($programacao, $permissoes)) { ?>
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Almoxarifado<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <?php if (in_array($desenvolvedor, $permissoes)) { ?>
            ...
            <ul class="nav navbar-nav " style="float: right">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" title="Ramal"> <span class="glyphicon glyphicon-cog"></span></a>
