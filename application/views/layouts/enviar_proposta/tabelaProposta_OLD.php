...
<html>
	...
	<table align="center" style=" float:left; width:805px;">';
            ...
            //CAPAS:
            if(
                in_array('a', $array_tipo_servico)&& in_array('b', $array_tipo_servico) && in_array('c', $array_tipo_servico) ||
            ...
            <tr>
                <td style="position:relative">
                    ...
                    $html.='<div style="position:absolute; top:460px;  z-index:9999; left:620px; font-size:11px ; width:160px;font-family:Calibri, Arial, sans-serif;"> Vigência de contrato ' . $tipo_proposta['vigencia'] . ' Meses. </div>';
                    $html.='<div style="position:absolute; top:790px; width:450px; z-index:9999; left:360px; height:400px;">
                         <table style="width:100%; border-spacing:0; border-collapse:collapse; font-family:Calibri, Arial, sans-serif; font-size:12px;">
                             ...
                             <tr style=" height:22px; color:#333" align="center">
                                <td style="text-align:center; font-weight:bold; width:25%">' . $VendedorRegiao . '</td>
                             </tr>
                         </table>
                    </div>
                </td>
