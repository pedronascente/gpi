...
<b>4. DA VENDA DOS EQUIPAMENTOS</b><br>

<p>
  4.1. Os equipamentos informados na letra “a” da cláusula 3.1 são cedidos em venda pela CONTRATADA para viabilizar a disponibilização do serviço de rastreamento veicular passivo e são instalados no veículo descrito no item 1.3 deste contrato, sendo que estes equipamentos são de exclusiva propriedade da CONTRATADA.
  <br><br>4.2. Fica estabelecido que somente pessoas autorizadas pela CONTRATADA podem ter acesso aos equipamentos vendidos, sendo que eventual necessidade de reparo ou troca do equipamento é de responsabilidade da CONTRATADA.
...
<p>
  ...
  <br><br>5.3. O serviço disponibilizado de rastreamento veicular será prestado nas áreas de cobertura do sinal de telefonia móvel de celular, podendo eventualmente sofrer interferências ou zonas de sombra, dependendo da venda do veículo rastreado.
...
<p>
  ...
  <br><br>7.3. O valor total do item 6.2, após 12 (doze) meses da assinatura deste instrumento, será automaticamente reajustado, de acordo com a variação acumulada do IGP-M do período.
</p>
...
<p>
  12.4. O rastreador veicular vendido e os serviços disponibilizados pela CONTRATADA, com a presente contratação, não se tratam de seguro patrimonial. Os equipamentos e serviço contratado pelo CONTRATANTE não são infalíveis e de modo algum equiparam-se a um seguro de veículo/carga. Desse modo, o CONTRATANTE tem ciência que a CONTRATADA não se responsabiliza por prejuízos ou danos de qualquer natureza, incluindo danos de integridade física de pessoas, bem como danos de ordem material e moral não previstos e totalmente alheios à natureza da contratação.
</p>
