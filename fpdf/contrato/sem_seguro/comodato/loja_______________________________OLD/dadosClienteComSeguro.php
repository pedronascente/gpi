        ...
        <div style=" margin:0 auto ;width:700px ; font-size:11px; " align="center">
            <div style="page-break-after:always;">
                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                     ...
                     <tr>
                       <td align="center">
                             <strong>CONTRATO DE PRESTAÇÃO DE SERVIÇO DE MONITORAMENTO MAIS RASTREAMENTO GARANTIDO</strong>
                       </td>
                     </tr>
                     <tr>
                         <td>
                             <p align="justify">
                                 <span  style="margin-left:45px">Pelo</span> presente instrumento particular e na melhor forma de direito, de um lado  VOLPATO SERVIÇOS DE SEGURANÇA LTDA,  estabelecida na   Rua Amazonas, 205  Bairro Navegantes , Porto Alegre/RS inscrita sob o CNPJ 07.086.942/0001-83 doravante denominada CONTRATADA e de outro  lado, a pessoa Física ou Jurídica doravante designada como CONTRATANTE, devidamente qualificado nas CONDIÇÕES GERAIS DO CONTRATO DE PRESTAÇÃO DE SERVIÇO DE MONITORAMENTO MAIS RASTREAMENTO GARANTIDO, que é parte complementar e indissociável deste Contrato, ajustam entre si, o presente contrato de prestação de serviço de monitoramento. 
                             </p> 
                         </td>
                     </tr>
                     <tr>
