			...
			break;
					...
					$html .='	</div><div style="page-break-after:always;">
						...
						<p align="justify">
							...
							<br />
							1.1 - Por este CONTRATO e na melhor forma de direito, a CONTRATADA compromete-se a prestar ao CONTRATANTE os serviços de monitoramento por GPS/GPRS para o(s) veículo(s) especificado(s) no item II do presente, doravante denominado de 
							SERVIÇO e tão somente este, não cobrindo danos decorrentes de danos morais e/ou materiais, responsabilidade civil, lucros cessantes e/ou qualquer prejuízo por destruição, perda ou reclamação que possa ser diretamente ou indiretamente 
							decorrentes de acidentes, caso fortuito, roubo ou força maior de qualquer natureza;<br />
						...
						<p align="justify">
							...
							<ul>
								...
								<li> b) Acionar em âmbito nacional o deslocamento de Pronta Resposta e Polícias, visando a localização e resgate do veículo monitorado após roubo ou furto do mesmo;</li>
								...
								<li> d) Prestar assistência técnica ao equipamento constante no item 4.2, exceto nos casos de uso indevido por parte da CONTRATANTE. A manutenção e assistência técnica serão efetuadas exclusivamente pela CONTRATADA, 
								sendo vedado ao CONTRATANTE, em qualquer hipótese, permitir a interferência de terceiros na manutenção das instalações, sob pena de responder pelos danos causados e respectivos reparos dos equipamentos;</li>
						...
						<p align="justify">
							...
							<ul>
								<li>a) Manter atualizado os dados cadastrais do veículo rastreado e seu proprietário/condutor junto à CONTRATADA;<br /></li>
								...
								<li>g) A CONTRATANTE declara estar ciente que o presente serviço não substitui ou a isenta de qualquer forma a contratação de seguro patrimonial, inexistindo pois, qualquer tipo
								 de cobertura, seja de qualquer natureza/abrangência, relativa a danos, bens, pessoas, terceiros, entre outros, devendo a CONTRATANTE para tanto, optar pelas coberturas que entender necessárias, 
								 através de empresa seguradora especializada e legalmente habilitada junto a SUSEP;
								</li>
							</ul>
					  </p>
					  <p align="justify">
							...
							<br />
							4.1 - Pela instalação dos equipamentos e ativação dos serviços de rastreamento e monitoramento, a CONTRATANTE pagará uma taxa de habilitação do sistema constante no item III - VALORES;<br />
							4.2 - Serão fornecidos ao CONTRATANTE, em regime de venda, para cada veículo rastreado, os seguintes itens:<br />
							<ul>
								<li> a) 01 (um) Módulo rastreador Maxtrack modelo MXT-150;</li>
								<li> b) 01 (um) CHIP de dados GPRS;</li>
								<li> c) 01 (um) Chicote padrão de ligações elétricas com 2 (dois) relés embutidos;</li>
								<li> d) 01 (uma) Sirene piezoelétrica de 120 dB;</li>
								<li> e) 01 (um) Botão de pânico;</li>
								<li> f) 01 (uma) Antena GPS;</li>
							</ul>
					  </p>
					  <p align="justify">
							
                                                        4.2.1 - O SIM CARD (chip) é de propriedade da Volpato Serviços de Segurança Ltda., cedido sob forma de comodato para cumprimento das obrigações assumidas no presente instrumento;<br />
							...
							4.6 - O não pagamento do SERVIÇO DE MONITORAMENTO especificado no item III autoriza a CONTRATADA a desabilitar imediatamente, remotamente, o sistema de rastreamento por GPS/GPRS, sem prévia comunicação, ficando o CONTRATANTE obrigado a devolver o
					    ...
					    <p align="justify">
							...
							<br />
							6.1 - O presente Contrato de Prestação de Serviço de Monitoramento terá vigência por 02 (dois) anos;<br />
							6.2 - A renovação do presente contrato dar-se-á de forma automática, sempre por 01 (um) ano, salvo aviso prévio de 30 (trinta) dias por uma das partes;
					 	</p>
					    <p align="justify"> 
							<strong>
					 	...
					 	<p align="justify">
							...
							<br />
							8.1 - Quaisquer avisos ou comunicações de uma PARTE para a outra, relativas a este contrato, deverá se dar sempre por escrito (carta registrada, fac-simille ou e-mail);<br />
							...
							8.3 - As PARTES elegem o foro da comarca de Porto Alegre/RS, com renúncia a qualquer outro, por mais privilegiado que seja, para dirimir quaisquer dúvidas ou questões que possam decorrer deste contrato;
					</p>
					  ...
					  <tr>
					   ...
					   <tr>
						...
						<br />
						<strong>CNPJ Nº: </strong>03.438.029/0001-48
						<br />
