        ...
        <form id="form_Usuario" name="form_Usuario" method="post" action="modulos/usuarios/src/controllers/usuarios.php" enctype="multipart/form-data">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 "> 
                    <div class="form-group">
                        ...
                        <select name="id_empresa" class="form-control" >
                            ...
                            <option value="1"<?=(isset($usuario['id_empresa']) && $usuario['id_empresa']=='1')?'selected' :''; ?>>VPSP</option>
                            <option value="2"<?=(isset($usuario['id_empresa']) && $usuario['id_empresa']=='2')?'selected' :''; ?>>VH</option>
                            <option value="3"<?=(isset($usuario['id_empresa']) && $usuario['id_empresa']=='3')?'selected' :''; ?>>VP - Alarmes</option>
                            <option value="4"<?=(isset($usuario['id_empresa']) && $usuario['id_empresa']=='4')?'selected' :''; ?>>VP - Guaíba</option>
                            <option value="5"<?=(isset($usuario['id_empresa']) && $usuario['id_empresa']=='5')?'selected' :''; ?>>Volpmann Matriz</option>
                            <option value="6"<?=(isset($usuario['id_empresa']) && $usuario['id_empresa']=='6')?'selected' :''; ?>>Volpmann - Filial</option>
                            <option value="7"<?=(isset($usuario['id_empresa']) && $usuario['id_empresa']=='7')?'selected' :''; ?>>Volpato - Matriz</option>
                            <option value="8"<?=(isset($usuario['id_empresa']) && $usuario['id_empresa']=='8')?'selected' :''; ?>>Volpato - Tramandaí</option>
							<option value="9"<?=(isset($usuario['id_empresa']) && $usuario['id_empresa']=='9')?'selected' :''; ?>>Volpato - Filial</option>
                        </select>
                    </div> 
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4 ">
            ...
            if ($acao == "editar") {
                ...
                if (!empty($listaPermissoes) && in_array(array("tipo_permissao" => "admin"), $permissoesUsuario)) {
                    ?>
                    <label><a id="modulos/usuarios/src/views/formularios/modal_atribuirPermissao.php?id_u=<?= $usuario['id']; ?>&tela=editar" class="modalOpen btn btn-primary botaoLoad" data-target="#modal">Atribuir Permissões</a></label>
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-striped">
                            <thead>
                                <tr>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-success botaoLoadForm">
                            Salvar
                        </button>
                        <?php if (!$rh) { ?>
                            <a href="index.php?pg=4" class="btn btn-danger">Voltar</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
