                ...
                <div class="col-xs-12 col-sm-6 col-md-4 "> 
                    <div class="form-group">
                        ...
                        <select name="id_empresa" class="form-control">
                           ...
                           <?php foreach($empresa->select() as $value){ ?>
                            <option value="<?=$value['id_empresa'];?>"<?=(isset($usuario['id_empresa']) && $usuario['id_empresa']== $value['id_empresa'])?'selected' :''; ?>><?=$value['nome_empresa'];?></option>
                           <?php  } ?>
                        </select>
                    </div> 
                </div>
