...
final class Contratos extends Crud {
    ...
    public function getTempoDeFinalizacao($dt_inicial, $dt_final) {
        ...
        $this->_sql = "
        SELECT 
        contratos.id_contrato AS 'NUMERO_CONTRATO',
		clientes.nome_cliente AS 'CLIENTE' , 
		clientes.ja_e_cliente AS 'JA_E_CLIENTE',
		contato_cliente.telefone1_contato AS TELEFONE,
		...
		INNER JOIN contato_cliente ON contato_cliente.id_cliente_contato = clientes.id_cliente	
		WHERE contratos.status_contrato = '3'   {$and}
...
//C:\wamp\www\gpi\modulos\captacao\src\models\classes\Contratos.class.php