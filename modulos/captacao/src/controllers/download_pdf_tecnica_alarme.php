...
$path__nomeEpastaDoArquivoEmAnexo = '../../../../../_MIDIAS_/captacao_agendamento/';
$dados = $_POST;
if($dados['acao']!='download_pdf_tecnica_alarme'){
    header('Location:/');
    exit;
}
...
$timestamp = date('YmdGis') . $json_list_captacao->captacao_id;
$nomeDoArquivo = $timestamp . '.pdf';



# - FUNCAO QUE GERA O PDF :
function geraPDF($nomeDoArquivo, $html, $tipo = "P") {
...
function getHtml($json_list_captacao){
    ...
    $html ='<table class="table table-striped table-bordered table-hover"  border="1" cellpadding="2"  cellspacing="0"   >     
                ...
                <tr>
                 ...
                 <tr>
                    <td colspan="4"><b>observação adicional :</b><br>'.$json_list_captacao->captacao_observacao_adicional.'</td>
                </tr>
            </tbody>
        </table>';   
...
# - GERAR PDF :
geraPDF($nomeDoArquivo, $html, $tipoFolha);
