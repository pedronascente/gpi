<form method="post" action="modulos/captacao/src/controllers/captacao.php">
    <div class="panel panel-primary">
        <div class=" panel-body">
            ...
            <?php
            //CONTATOS :
            include_once  __DIR__ . '/../frm_contato.php';
    ...
    include_once __DIR__ . '/../frm_endereco_residencial.php';
    ?>
    <div class="row">
        <div class="col-xs-12  col-sm-8 col-md-8">
            ...
            <?php
            if (!isset($cliente)) {
                echo ' <input type="hidden" name="CLIENTE[status_cadastro]" value="1" />';
            } else {
                echo '<input type="hidden" name="CLIENTE[status_cadastro]" value="2" />';
            }
            ?>

            <input type="hidden" name="id" id="id" value="<?= $id_cliente; ?>" />
            <input type="hidden" name="acao" value="cadastro_cliente_seguro" />
