    ...
    if (isset($tipo_cadastro) && $tipo_cadastro == 'rastreador_com_seguro') {
        $frm_cliente =  __DIR__ . "./seguro/frm_cliente.php";
        $frm_veiculos = __DIR__ . "./seguro/frm_veiculos.php";
    } else {
        $frm_cliente =  __DIR__ . "./frm_cliente_2.php";
        $frm_veiculos = __DIR__ . "./frm_veiculos.php";
    }
    ...
    if (!empty($id_cliente)) :
        ...
        /*
          *
          * @ Descricao = Buscar tipo de cadastro. 
          * @ Param = int id_cliente
          * @ Return = array 
          * @ Data_atualizacao = 31/05/2022
        */
