...
<ul class="nav nav-tabs">
    ...
    <li><a data-toggle="tab" href="#tabs-2">Histórico Agenda (<?= $total_abertos; ?>)</a></li>
...
<div class="tab-content">
            ...
            <div class="panel-body">
                <table class="table table-bordered">
                    <tr align="center">
                        ...
                        <td width="14,28%"<?= ($status == 'finalizado') ? Funcoes::colorirLinha(1) : Funcoes::colorirLinha(0); ?>  class="bordaTD cursorPointer" id="index.php?pg=18&status=finalizado">Finalizado</td>
                    </tr>
                </table>
                <br>
                <div class="row">
    ...
    <div id="tabs-3" class="tab-pane fade">
        <div class="panel panel-primary">
            <div class="panel-body">
                <form action="modulos/captacao/src/controllers/vendedor_registra_captacao.php" method="post" id="basic_validate_usuario" novalidate="novalidate"  name="FORMULARIO_VENDEDOR_ABRIR_CAPTACAO" > 
                    ...
                    <div class="row" id="captacao_indicador">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12">
                            ...
                            <input type="hidden" name="origem" class="form-control"  value="Vendedor ID : <?=$_SESSION['user_info']['id_usuario']; ?>">
                            ...
                            <input type="hidden" name="acao"   class="form-control"  value="new">
        ...
        $.ajax({
            ...
            success: function (json){
                if(json.captacao!=false){
                   ...
                   $('#captacao_indicador').css('display','none');
                }else{
                   ...
                   $('#captacao_indicador').removeAttr('disabled',true).attr('required',true);;
