...
$consultor = filter_input(INPUT_GET, "cidu");
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <select name="cidu" id="cidu" class="form-control">
                ...
                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                    <div class="form-group">
                        ...
                        <select name="ddd" id="ddd" class="form-control">
                            ...
                            <?php
                            foreach ($listddd as $ddd) {
                                $selected = $ddd['regiao_ddd'] == $ddd ? "selected" : "";
                                echo "<option value=\"{$ddd['regiao_ddd']}\" {$selected}>({$ddd['regiao_ddd']})</option>";
                            }
                            ?>
                        </select>
                    </div>
