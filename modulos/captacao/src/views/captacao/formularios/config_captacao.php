                                ...
                                <div class="table-responsive">
                                    <table  class="table table-striped table-bordered  table-hover dataTableBootstrapSemOrdem" cellspacing="0" >
                                        <thead>
                                            <tr>
                                                <th  width="5%">
                                                    <a href="javascript:void(0)" class="btn btn-sm btn-danger botaoLoadForm  btn_delete_captacao_ajax"> 
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($listarCaptacao as $k => $captacao) :
                                                ...
                                                $obs = !empty($captacao['captacao_obs']) ? $captacao['captacao_obs'] : "";
                                                ?>
                                                <tr align="center">
                                                    <td> <input type="checkbox" name="_checkbox_delete_captacao"   value="<?=$captacao['captacao_id'];?>" style="cursor: pointer;width: 20px ; height: 20px "></td>
                                                    <td ><?= $data; ?></td>
                                                    <td width="5%" ><?= '(' . $ddd . ')'; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <script type="text/javascript">
                                                    $(function(){
                                                            ...
                                                            function deleleCaptacaoViaAjax(array_id_captacao){
                                                                let = data_arryay =array_id_captacao;
                                                                 console.log(array_id_captacao);                                                         
                                                                $.post("modulos/captacao/src/controllers/captacao.php", {
                                                                    data: data_arryay,
                                                                    acao : 'delete_captacao_ajax'
                                                                },
                                                                function(data, status){
                                                                    window.location.replace('index.php?pg=2'); 
                                                                });
                                                            }
                                                            $('.btn_delete_captacao_ajax').click(function(){
                                                                if(confirm("Deseja realmentes excluir?")){
                                                                    let  array_id_captacao =  getSelectedCheckboxValues('_checkbox_delete_captacao');
                                                                    let t = array_id_captacao.length;   
                                                                    if(t>0){
                                                                        deleleCaptacaoViaAjax(array_id_captacao);
                                                                    }else{
                                                                        alert('Selecione pelo menos um item da lista para excluir. ')
                                                                    }
                                                                }
                                                            });
                                                        })
