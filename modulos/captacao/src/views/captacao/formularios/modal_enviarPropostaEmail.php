                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-actions">
                            ...
                            <input type="hidden" name="id_proposta" id="id_proposta" value="<?= $_GET['id']; ?>"> 
                            <input type="hidden" name="id_captacao" value="<?= $_GET['id_captacao']; ?>"> 
...
<script language="javascript" type="text/javascript">
    $(function () {
        ...
        $('#form_enviaProposta').submit(function (e) {
            ...
            $.ajax({
                url: "modulos/captacao/src/controllers/enviar_proposta.php",
                dataType: 'json',
                type: 'post',
                data: formulario,
                beforeSend: function () {
                ...
                success: function (json) {
                    if (json.type == 1) {
                        ...
                        location.reload();
                    } else if (json.type == "faill_data") {
                	   	alert('Não foi possivel enviar esta Proposta, dados do usuário incompletos!'+
						'\n\n Nome : '+json.data.nome + 
						'\n Usuario : '+json.data.usuario +
						'\n Assinatura : '+json.data.assinatura +
						'\n Email :'+json.data.usuario_email +
						'\n AssinaturaEmail :'+json.data.assinaturaEmail
						);
