<!--
//namespace C:\wamp\www\gpi\modulos\captacao\src\views\captacao\formularios\frm_edit_formulario_a.php
-->
        ...
        <div class="row" >
            <div class="col-xs-12  col-md-12">
                <div class="form-group" >
                    ...
                    <textarea class="form-control" name="captacao_observacao_adicional"><?=$captacao_observacao_adicional;?></textarea>
                </div>   
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-actions">
                    <input type="hidden" name="acao" value="editar-frm_edit_formulario_a"> 
