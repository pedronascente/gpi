...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
       <?php  
          for($a = 0; $a <count($permissoes);  $a++){
            $adfdsfsd[] = $permissoes[$a]['tipo_permissao'];

          }

                $rrrr= in_array("sac", $adfdsfsd);



        if(isset($_GET['consulta']) && $_GET['consulta']=='administrativo'  || $rrrr == true){ ?>
