...
switch ($acao) :
    ...
    case "consultaSPCSERASA" :
        ...
        //ATUALIZAR STATOS DA CAPTACAO :
        if (!empty($id_captacao)) {
            $captacao->updateCaptacao(array("captacao_id" => $id_captacao, "captacao_status" => "comprado"));
        }
        if ($tipoFrm == 'aprovar') :
            switch ($retorno) :
    ...
    //RESPONSAVEL POR ADICIONAR OS NIVEIS DE CAPTACAO :
    ...
    //RESPONSAVEL CADASTRAR REGRAS DOS NIVEIS DE CAPTACAO :
    ...
    //RESPONSAVEL CADASTRAR INTERESSES DOS NIVEIS DE CAPTACAO :    
    ...
    //RESPONSAVEL POR DELETAR OS NIVEIS DE CAPTACAO:
    ...
    case "exportarRelatorioCaptacao":
        ...
        foreach ($lista as $k => $dados) {
            ...
            $html .= "<tr>
                        ...
                        <td>" . utf8_encode($captacao_serviço) . "</td>
