<?php  // namespace C:\wamp\www\gpi\modulos\captacao\src\views\captacao\formularios\visualizar_dados_formulario_a.php ?>
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="form-actions">
                                 <?php  if($vendedor=='sim'){ ?>
                                    ...
                                    ?>
                                    <a id="modulos/captacao/src/views/captacao/formularios/modal_enviarEmailTecnico.php?id_captacao=<?= $id_captacao; ?>" class="botaoLoad modalOpen btn btn-success" data-target="#modal">  <span class="glyphicon glyphicon-envelope"></span>  Enviar Email </a>   
                                    <a href="index.php?pg=<?= $numero_pagina;?>&id=<?= $id_captacao; ?>&acao=editar&voltar=<?= @$_GET['voltar'];?>" class="btn  btn-danger"> Editar  </a>               
