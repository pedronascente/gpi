...
<div class="panel panel-primary  ">
    ...
    <div class="panel-default panel-body ">
        ...
        if (!empty($id_cliente)) {
            ...
            include_once("modulos/captacao/src/views/rastreador/formularios/frm_cliente.php");
            echo '</div>';
            //FORM : Veiculos :
            echo '<div class="tab-pane fade" id="veiculos">';

            include_once('modulos/captacao/src/views/rastreador/formularios/frm_veiculos.php');
            echo '</div>';
            //FORM : Anexos
