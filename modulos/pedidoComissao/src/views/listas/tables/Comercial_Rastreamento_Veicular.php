      ...
      if($lista_pedidoComissao){
            foreach ($lista_pedidoComissao as $k => $dados) :
                ...
                <tr align="center">
                    ...
                    <td><?=$pedidoComissao->get_pedido_comissao_id_contrato();?></td>
                    <td align="center"><?=$pedidoComissao->get_pedido_comissao_qtd_veiculo(); ?></td>
                    <td><?=$pedidoComissao->get_pedido_comissao_placa();?></td>
                    <td><span class="span_esquerdo"> R$ </span><span class="span_direito"><?=$pedidoComissao->get_pedido_comissao_tx_instalacao(); ?></span></td>
