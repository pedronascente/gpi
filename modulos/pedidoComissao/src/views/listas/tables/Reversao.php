<thead>
    <tr>
        ...
        <th>Reclamação</th>
        <th>Inconsistencia
            <a id="modulos/pedidoComissao/src/views/listas/helpeInconsistenciaUsuario.php" class="modalOpen" data-target="#modalAjuda"> <span ></span>
            </a>
        </th>
        <th>Ação</th> 
    </tr>
        ...
        if($lista_pedidoComissao){            
            foreach ($lista_pedidoComissao as $k => $dados) :
                ...
                <tr align="center">
                    ...
                    <td><?=$pedidoComissao->get_pedido_comissao_empresa();?></td>
                    <td><?=$pedidoComissao->get_pedido_comissao_reclamacao();?></td>
